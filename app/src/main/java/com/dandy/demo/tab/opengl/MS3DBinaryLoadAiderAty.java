...
public class MS3DBinaryLoadAiderAty extends BaseDemoAty {
...
//                        mActor.initData(data);
                        ...
                        String filePath = "/sdcard/dcktest.dat";
                        File file = new File(filePath);
                        JFileHelper.saveObjectToBinaryFile(data, file);
                        long parseTime = System.currentTimeMillis();
                        MS3DData data1 = (MS3DData) JFileHelper.getObjectFromBinaryFile(file);
                        long endTime = System.currentTimeMillis();
                        data1.setLoadTime(endTime-parseTime);
                        LogHelper.d(TAG, LogHelper.getThreadName() + " data1=" + data1.toString()+" endTime-parseTime="+(endTime-parseTime));
                    }
