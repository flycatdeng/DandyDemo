...
public class MainActivity extends Activity {
    ...
    private void initViews() {
        ...
        mAboutTextView = (TextView) findViewById(R.id.aty_main_tab_item_about);
        ...
        mAboutTextView.setOnClickListener(new OnTabClickListener());
        ...
        Intent intent3 = new Intent(mContext, LargeActivity.class);
        list.add(getAtyDecorView("LargeActivity", intent3));
        Intent intent4 = new Intent(mContext, AboutActivity.class);
        list.add(getAtyDecorView("AboutActivity", intent4));
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.aty_main_tab_item_large:
                    ...
                    break;
                case R.id.aty_main_tab_item_about:
    ...
    private void setTabTextsDefualtColor() {
        ...
        mAboutTextView.setTextColor(getResources().getColor(R.color.normalText));
    }
    ...
    private void setTabTextsColor(int selectedId) {
        ...
        switch (selectedId) {
            ...
            case R.id.aty_main_tab_item_large:
                ...
                break;
            case R.id.aty_main_tab_item_about:
                mAboutTextView.setTextColor(getResources().getColor(R.color.normalLightText));
                break;
        }
    }
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            switch (position) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    setTabTextsColor(R.id.aty_main_tab_item_about);
                    break;
            }
        }
