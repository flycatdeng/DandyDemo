 ...
 * Wechat:flycatdeng
 */
public class ActorObject3D extends Actor {
    private static final String TAG = "ActorObject3D";
    ...
    public ActorObject3D(Context context) {
        super(context);
        mDefaultTextureOptions = TextureOptions.defaultMipmapOptions();
        mDefaultMaterialName = "module/obj3d/gles_engine_object3d/default_simple_object3d.mat";
    }
